...
class local_appcrueservices_grades_external extends external_api {
    ...
    public static function get_user_grades($studentemail, $apikey) {
        global $DB, $CFG, $USER;

        self::validate_parameters(self::get_user_grades_parameters(), [
